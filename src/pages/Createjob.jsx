...
function Createjob() {
  ...
  function handleCreateJob(e) {
    ...
    e.preventDefault();
    axios
      .post("https://jobholic.onrender.com/api/jobs", updatedJob, {
        headers: {
  ...
  return (
    <>
      <ToastContainer />
      <div className="bg-[#F6F7FA] sm:mx-auto sm:w-full py-6">
        <img
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <div className="w-1/2">
                ...
                >
                  <option defaultValue>Choose a job type</option>
                  <option value="full-time">full-time</option>
                  <option value="part-time">part-time</option>
                </select>
                <small className="text-red-900 ">{errorDaata.job_type}</small>
              </div>
            </div>
            <div className="flex gap-2">
              <div className=" w-1/2">
              ...
              <div className="w-1/2">
                ...
                <small className="text-red-900 ">{errorDaata.job_level}</small>
              </div>
              <div className="w-1/2">
                <label
                  htmlFor="experience"
                ...
                <small className="text-red-900 ">{errorDaata.category}</small>
              </div>
            </div>
            ...
            <div>
              ...
              <small className="text-red-800">{errorDaata.description}</small>
            </div>
